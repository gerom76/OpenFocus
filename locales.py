    ...
    def __init__(self):
        ...
        self.translations = {
            'en': {
                ...
                'label_pyr_base_moderate': 'Moderate',
                'label_pyr_base_balanced': 'Balanced',
                'label_pyr_noise_gate': 'Ignore grain when nothing is sharp',
                'label_pyr_noise_pct': 'Grain estimate:',
                'label_pyr_noise_pct_minimal': 'Minimal',
                'label_pyr_noise_pct_low': 'Low',
                'label_pyr_noise_pct_balanced': 'Balanced',
                'label_pyr_noise_pct_broad': 'Broad',
        ...
        consistency.</p>''',
            ...
            'zh': {
                ...
                'label_pyr_base_moderate': '适中',
                'label_pyr_base_balanced': '均衡',
                'label_pyr_noise_gate': '无清晰内容时忽略噪点',
                'label_pyr_noise_pct': '噪点估计范围:',
                'label_pyr_noise_pct_minimal': '极小',
                'label_pyr_noise_pct_low': '较小',
                'label_pyr_noise_pct_balanced': '均衡',
                'label_pyr_noise_pct_broad': '较大',
